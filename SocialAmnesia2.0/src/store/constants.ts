...
const INCREMENT_CURRENTLY_DELETING_ITEMS_DELETED = "incrementCurrentlyDeletingItemsDeleted";
const RESET_CURRENTLY_DELETING_ITEMS_DELETED = "resetCurrentlyDeletingItemsDeleted";
